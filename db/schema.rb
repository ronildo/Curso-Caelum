...
ActiveRecord::Schema.define(:version => 20120112184621) do
  ...
  add_index "pratos_restaurantes", ["prato_id"], :name => "index_pratos_restaurantes_on_prato_id"
  add_index "pratos_restaurantes", ["restaurante_id"], :name => "index_pratos_restaurantes_on_restaurante_id"
